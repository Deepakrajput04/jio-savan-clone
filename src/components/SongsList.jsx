...
const SongsList = ({
  ...
  return (
    <div className="flex justify-between items-center w-[80vw] lg:w-[50vw] mb-2 lg:mb-1 p-1 px-3 hover:bg-white hover:shadow-md">
      <GoPlay
        className="text-3xl text-gray-500 hover:text-gray-700 transition-all ease-out duration-300 cursor-pointer"
        onClick={() =>
      ...
      <div>
        <span className="font-thin test-xs text-gray-500 hidden lg:block">

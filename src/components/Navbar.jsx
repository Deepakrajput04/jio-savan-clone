  ...
  return (
    <nav className="flex justify-between items-center py-3 border-none lg:border px-2 fixed top-0 left-0 right-0 bg-[#f5f5f5ff]">
      <div className="flex flex-col lg:flex-row justify-between items-center mx-auto lg:mx-0">
        ...
        <div className="flex test-[24px] lg:text-[15px] gap-5 text-gray-600 font-semibold h-full">
      ...
      <div className="hidden lg:flex justify-between items-center gap-4">
        <div className="flex justify-center gap-2">
          <div className="flex flex-col text-sm">
            ...
            <span className="text-[12px] text-gray-500 mt-2">Hindi</span>
          </div>
          <MdOutlineKeyboardArrowDown className="text-xl text-gray-500 mt-2" />
        </div>
